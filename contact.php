...
<section class="contact">
   ...
   <form action="" method="post">
      ...
      <input type="number" name="number" required placeholder="Nhập SDT của bạn" class="box">
      <textarea name="message" class="box" placeholder="Nội dung liên hệ" id="" cols="30" rows="10"></textarea>
