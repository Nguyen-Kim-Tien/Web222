...
<div class="container" id="container">
  <div class="form-container sign-in-container">
    <form action="" method="post">
      ...
      <button class="ghost" id="signUp1"> <a href="registerr.php">Đăng ký</a></button>
    </form>
  </div>
  <div class="overlay-container">
    <div class="overlay">
      <div class="overlay-panel overlay-right">
        <h1>Hello, Friend!</h1>
        <p>Bạn sẽ cần một tài khoản để bắt đầu mua sắm với chúng tôi!</p>
        <p>Bạn chưa có tài khoản, đăng ký thôi nào!</p>
        <button class="ghost" id="signUp"> <a href="registerr.php">Đăng ký</a></button>
      </div>
    </div>
  </div>
</div>
